...
<body>
	...
	<div class="alert alert-info">
		...
		<strong>Bienvenidos</strong>  <font face="comic sans">En Charitos Store tenemos una gran variedad de ropa para damas
Para simplificar el proceso de pedido, debe registrarse en el siguiente formulario.</font></div>
	...
	<form class="form-horizontal" name="form1" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" target="_self" >
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" name="txtAlamat"   id="txtAlamat"  value="<?php echo $dataAlamat; ?>" placeholder="Dirección"/ required> <span>Domicilio,Calle,barrio, etc</span>
			</div>
		</div>
		<div class="control-group">
