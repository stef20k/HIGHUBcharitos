...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Charitos Store Tienda Online</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Charitos Store Tienda Online venta de ropa para damas">
    <meta name="author" content="Charitos Store">
	<!-- Less styles  
                ...
                <div class="container">
                  ...
                  <div class="nav-collapse">
                    <ul class="nav">
					  ...
					  <li class=""><a href="http://www.CharitosStore.com/exchanger-retiro-recarga-paypal-peru/">Servicios Paypal</a></li>
					</ul>
